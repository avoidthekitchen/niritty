...
Niritty is a native macOS workspace environment for terminal and browser windows arranged with [Niri](https://niri-wm.github.io/niri/)-style scrollable columns. **The project is currently a working experimental prototype, not a production-ready application. **
